...
var z2 = function(t2, e) {
  ...
  this.g.Authorization = "Bearer " + t2;
};
var G2 = (
  /** @class */
  function() {
    ...
    return t2.prototype.getToken = function() {
      ...
      this.V = t3, // Fire with initial user.
      t3(j.UNAUTHENTICATED);
...
var B = (
  ...
  function() {
    function t2(t3) {
      ...
      this.currentUser = j.UNAUTHENTICATED, this.C = false, /**
           * Counter used to detect if the token changed while a getToken request was
           * outstanding.
           */
      this.N = 0, /** The listener registered with setChangeListener(). */
      this.V = null, this.forceRefresh = false, this.D = function() {
        ...
        (this.D(null), t3.get().then(function(t4) {
          e.auth = t4, e.D && // tokenListener can be removed by removeChangeListener()
    ...
    return t2.prototype.getToken = function() {
      ...
      this.V = t3, // Fire the initial event
      this.C && t3(this.currentUser);
    }, t2.prototype.S = function() {
...
var xt = (
  ...
  function() {
    function t2(t3) {
      void 0 === t3 && (t3 = St.empty()), this.It = t3, /** A map that contains the accumulated changes in this builder. */
    ...
    t2.prototype.yt = function(t3, e) {
      var n2 = this, r2 = false, i = this.It.field(t3), o = Dt(i) ? (
...
var ee = (
  /**
       ...
       */
  function(t2, e, n2, r2, i, o, u, s) {
    void 0 === e && (e = null), void 0 === n2 && (n2 = []), void 0 === r2 && (r2 = []), void 0 === i && (i = null), void 0 === o && (o = "F"), void 0 === u && (u = null), void 0 === s && (s = null), this.path = t2, this.collectionGroup = e, this.xt = n2, this.filters = r2, this.limit = i, this.limitType = o, this.startAt = u, this.endAt = s, this.Nt = null, // The corresponding `Target` of this `Query` instance.
...
function ce(t2) {
  ...
  if (null === e.Nt) {
    ...
    var n2 = se(e), r2 = ue(e);
    if (null !== n2 && null === r2)
      n2.ut() || e.Nt.push(new Zt(n2)), e.Nt.push(new Zt(
        $.ht(),
        "asc"
        /* ASCENDING */
      ));
...
un.EMPTY = null, un.RED = true, un.Ht = false, // end LLRBEmptyNode
un.EMPTY = new /** @class */
(function() {
  function t2() {
    this.size = 0;
  ...
  function() {
    ...
    return t2.prototype.track = function(t3) {
      ...
      n2 ? (
        ...
        0 !== t3.type && 3 === n2.type ? this.be = this.be.zt(e, t3) : 3 === t3.type && 1 !== n2.type ? this.be = this.be.zt(e, {
          type: n2.type,
          doc: t3.doc
...
var xn = (
  ...
  function() {
    function t2(t3) {
      this.un = t3, /** The internal state of all tracked targets. */
      this.hn = /* @__PURE__ */ new Map(), /** Keeps track of the documents to update since the last raised snapshot. */
      ...
      this.In(t3, function(n2) {
        ...
        switch (t3.state) {
          case 0:
            ...
            break;
          case 1:
            r2.cn(), r2.Xe || // We have a freshly added target, so we need to reset any state
            // that we had previously. This can happen e.g. when remove and add
            // back a target for existence filter mismatches.
            r2.nn(), r2.tn(t3.resumeToken);
            break;
          case 2:
          ...
          case 3:
            ...
            break;
          case 4:
            e.An(n2) && // Reset the target and synthesizes removes for all existing
            // documents. The backend will re-add any documents that still
            // match the target before it sends the next global snapshot.
            (e.Rn(n2), r2.tn(t3.resumeToken));
            break;
          default:
            x2();
        }
    ...
    t2.prototype.Pn = function(t3) {
      ...
      if (r2) {
        ...
        if (qt(i))
          ...
          this.gn(e) !== n2 && // Existence filter mismatch: We reset the mapping and raise a new
    ...
    t2.prototype.En = function(t3, e, n2) {
      if (this.An(t3)) {
        ...
        this.pn(t3, e) ? r2.sn(
          ...
          r2.rn(e)
        ), this._n = this._n.zt(e, this.bn(e).delete(t3)), n2 && (this.ln = this.ln.zt(e, n2));
      }
...
var lr = (
  ...
  function() {
    function t2(t3) {
      ...
      this.result = void 0, this.error = void 0, this.xn = false, // Set to true when .then() or .catch() are called and prevents additional
      // chaining.
      this.Nn = false, t3(function(t4) {
        e.xn = true, e.result = t4, e.Dn && // value should be defined unless T is Void, but we can't express
...
var dr = (
  ...
  function() {
    function t2(e, r2, i) {
      this.name = e, this.version = r2, this.Un = i, // NOTE: According to https://bugs.webkit.org/show_bug.cgi?id=197050, the
      // bug we're checking for should exist in iOS >= 12.2 and < 13, but for
      // whatever reason it's much harder to hit after 12.2 so we only proactively
      // log on 12.2.
      12.2 === t2.Qn(getUA()) && A2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
...
function _r(t2) {
  ...
  if (e >= 12.2 && e < 13) {
    ...
    if (t2.message.indexOf(r2) >= 0) {
      ...
      return br || (br = true, // Throw a global exception outside of this promise chain, for the user to
      // potentially catch.
      setTimeout(function() {
        throw i;
      }, 0)), i;
...
var Ir = (
  ...
  function() {
    function t2(t3, e, n2, r2, i) {
      this._s = t3, this.fs = e, this.ds = n2, this.op = r2, this.ws = i, this.Es = new fr(), this.then = this.Es.promise.then.bind(this.Es.promise), // It's normal for the deferred promise to be canceled (due to cancellation)
      // and so we attach a dummy catch callback to avoid
      // 'UnhandledPromiseRejectionWarning' log spam.
      this.Es.promise.catch(function(t4) {
      });
    }
...
var Ii = (
  ...
  function() {
    function t2(t3, e, n2, r2) {
      this.userId = t3, this.Qt = e, this.Ei = n2, this.Ti = r2, /**
    ...
    t2.prototype.Dr = function(t3, e) {
      ...
      return r2.hs({
        ...
        0 === o ? (
          ...
          (i !== H2.q && e(new tt(xr(n2)), i), // set nextToReport to be this sequence number. It's the next one we
  ...
  function() {
    ...
    t2.prototype.qr = function(t3, e) {
      ...
      return ji(t3).hs({
        ...
        (n2(o, e2), o = i.ce() ? i.oe() : null), // Skip to the next key (if there is one).
        o ? r3.ss(o.path.it()) : r3.done();
      }).next(function() {
        for (; o; )
...
var qi = (
  ...
  function(t2) {
    function e(e2, n2) {
      var r2 = this;
      return (r2 = t2.call(this) || this).jr = e2, r2.Wr = n2, // A map of document sizes prior to applying the changes in this buffer.
      r2.Gr = new gi(function(t3) {
        return t3.toString();
      }, function(t3, e3) {
...
var Yi = (
  ...
  function() {
    function t2(e, n2, r2, i, o, u, s, a, c, h2) {
      if (this.allowTabSynchronization = e, this.persistenceKey = n2, this.clientId = r2, this.Zr = o, this.window = u, this.document = s, this.eo = c, this.no = h2, this.so = null, this.io = false, this.isPrimary = false, this.networkEnabled = true, /** Our window.unload handler, if registered. */
      this.ro = null, this.inForeground = false, /** Our 'visibilitychange' listener if registered. */
...
var to = (
  ...
  function() {
    function t2(t3, e, n2, r2) {
      this.persistence = t3, this._c = e, this.Qt = r2, /**
      ...
      this.dc = new gi(function(t4) {
        return Ut(t4);
           ...
           */
      this.wc = X2.min(), this.zo = t3.Qo(n2), this.Ec = t3.$r(), this._o = t3.Sr(), this.Tc = new Zi(this.Ec, this.zo, this.persistence.Ko()), this.wo = t3.Wo(), this._c.cc(this.Tc);
    }
        ...
        case 0:
          return n2 = O2(t2), r2 = n2.zo, i = n2.Tc, [4, n2.persistence.runTransaction("Handle user change", "readonly", function(t3) {
            ...
            return n2.zo.pi(t3).next(function(u2) {
              return o2 = u2, r2 = n2.persistence.Qo(e), // Recreate our LocalDocumentsView using the new
              // MutationQueue.
              i = new Zi(n2.Ec, r2, n2.persistence.Ko()), r2.pi(t3);
            }).next(function(e2) {
    ...
    return function(t4, e2, n3, r3) {
      ...
      return o.forEach(function(t5) {
        u = u.next(function() {
          ...
          k2(null !== u2), (!o2 || o2.version._(u2) < 0) && ((o2 = i2.Ss(t5, o2, n3)) && // We use the commitVersion as the readTime rather than the
    ...
    e.$e.forEach(function(e2, o2) {
      ...
      if (s2) {
        ...
        if (a2.l() > 0) {
          ...
          i = i.zt(o2, c), // Update the target data if there are target changes (or if
          ...
          */
          function(t4, e3, n3) {
            return k2(e3.resumeToken.l() > 0), 0 === t4.resumeToken.l() || // Don't allow resume token changes to be buffered indefinitely. This
            // allows us to be reasonably up-to-date after a crash and avoids needing
            // to loop over all active queries on shutdown. Especially in the browser
            // we may not get time to do anything interesting while the current tab is
            // closing.
            (e3.Ot.W() - t4.Ot.W() >= 3e8 || n3.qe.size + n3.Ue.size + n3.Qe.size > 0);
...
function uo(t2, e, n2, r2, i) {
  ...
  return n2.forEach(function(t3) {
    ...
    return n2.forEach(function(n3, u) {
      ...
      u instanceof Vt && u.version.isEqual(X2.min()) ? (
        // NoDocuments with SnapshotVersion.min() are used in manufactured
        // events. We remove these documents from cache since we lost
        // access.
        (e.li(n3, a), o2 = o2.zt(n3, u))
      ) : null == s || u.version._(s.version) > 0 || 0 === u.version._(s.version) && s.hasPendingWrites ? (e.ai(u, a), o2 = o2.zt(n3, u)) : N2("LocalStore", "Ignoring outdated watch update for ", n3, ". Current version:", s.version, " Watch version:", u.version);
    }), o2;
  });
}
function so(t2, e) {
  ...
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(s) {
      switch (s.label) {
        ...
        case 5:
          return r2.fc = r2.fc.remove(e), r2.dc.delete(i.target), [
            2
            /*return*/
          ];
      }
  ...
  function() {
    ...
    return t2.prototype.Ai = function(t3) {
      ...
      return this.Bc.Ae(function(t4) {
        var e2 = t4.key.path;
        return !!n2.nt(e2) && // Rows with document keys more than one segment longer than the query
        // path can't be matches. For example, a query on 'rooms' can't match
        // the document /rooms/abc/messages/xyx.
        // TODO(mcg): we'll need a different scanner when we implement
        // ancestor queries.
        (e2.length === r2 && (u = u.add(t4.Mc)), true);
...
var _o = (
  ...
  function() {
    function t2(t3, e) {
      this.Ei = t3, this.Wc = e, /** Underlying cache of documents and their read times. */
  ...
  function() {
    function t2(t3) {
      this.persistence = t3, /**
           ...
           */
      this.Gc = new gi(function(t4) {
        return Ut(t4);
      }, Mt), /** The last received snapshot version. */
      this.lastRemoteSnapshotVersion = X2.min(), /** The highest numbered target ID encountered. */
...
var Lo = (
  ...
  function() {
    function t2(t3, e, n2, r2, i) {
      this.window = t3, this.Zr = e, this.persistenceKey = n2, this.la = r2, this._a = null, this.fa = null, this.k = null, this.da = this.wa.bind(this), this.Ea = new rn(C), this.Er = false, /**
    ...
    return t2.Kn = function(t3) {
      ...
      this.xa(t3, e, n2), // Once a final mutation result is observed by other clients, they no longer
    ...
    t2.prototype.pa = function(t3) {
      ...
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(e) {
          return t3.user.uid === this.currentUser.uid ? [2, this._a.eu(t3.batchId, t3.state, t3.error)] : (N2("SharedClientState", "Ignoring mutation for non-active user " + t3.user.uid), [
            2
            /*return*/
          ]);
        });
...
var jo = (
  ...
  function(t2) {
    ...
    return __extends(e, t2), e.prototype.Su = function(t3, e2, n2, r2) {
      ...
      this.vu(f.initMessageHeaders, e2), // Sending the custom headers we just added to request.initMessageHeaders
      ...
      return I4(g, WebChannel.EventType.OPEN, function() {
        ...
        if (!b) {
          ...
          if (i) {
            ...
            void 0 === u && (u = M2.INTERNAL, s = "Unknown error status: " + o + " with message " + i.message), // Mark closed so no further events are propagated
            b = true, _2.Ru(new q2(u, s)), g.close();
          } else
    ...
    function() {
      ...
      t2.prototype.vu = function(t3, e) {
        if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.2.9", // Content-Type: text/plain will avoid preflight requests which might
...
var Qo = (
  ...
  function() {
    function t2(t3, e, n2, r2, i) {
      void 0 === n2 && (n2 = 1e3), void 0 === r2 && (r2 = 1.5), void 0 === i && (i = 6e4), this.Zr = t3, this.fs = e, this.xu = n2, this.Nu = r2, this.$u = i, this.Fu = 0, this.Ou = null, /** The last backoff attempt, as epoch milliseconds. */
...
var Yo = (
  ...
  function() {
    function t2(t3, e, n2, r2, i, o) {
      this.Zr = t3, this.Uu = n2, this.Qu = r2, this.Ku = i, this.listener = o, this.state = 0, /**
           * A close count that's incremented every time the stream is closed; used by
           * getCloseGuardedDispatcher() to invalidate callbacks that happen after
           * close.
           */
      this.Wu = 0, this.ju = null, this.stream = null, this.Gu = new Qo(t3, e);
    }
          ...
          switch (n2.label) {
            case 0:
              ...
              this.Wu++, 3 !== t3 ? (
                ...
                this.Gu.reset()
              ) : e && e.code === M2.RESOURCE_EXHAUSTED ? (
                // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                (A2(e.toString()), A2("Using maximum backoff delay to prevent overloading the backend."), this.Gu.Mu())
              ) : e && e.code === M2.UNAUTHENTICATED && // "unauthenticated" error means the token was rejected. Try force refreshing it in case it
              // just expired.
              ...
              this.state = t3, [4, this.listener.Tu(e)];
            case 1:
              return n2.sent(), [
                2
                /*return*/
    ...
    t2.prototype.nh = function() {
      ...
      this.Ku.getToken().then(function(e2) {
        t3.Wu === n2 && // Normally we'd have to schedule the callback on the AsyncQueue.
    ...
    e.prototype.uh = function(t3) {
      ...
      e2.database = Qn(this.Qt), e2.addTarget = function(t4, e3) {
        ...
        return (n3 = qt(r2) ? {
          ...
          query: Jn(t4, r2)
        }).targetId = e3.targetId, e3.resumeToken.l() > 0 ? n3.resumeToken = Rn(t4, e3.resumeToken) : e3.Ot._(X2.min()) > 0 && // TODO(wuandy): Consider removing above check because it is most likely true.
        // Right now, many tests depend on this behaviour though (leaving min() out
        // of serialization).
        (n3.readTime = Ln(t4, e3.Ot.j())), n3;
      }(this.Qt, t3);
  ...
  function(t2) {
    ...
    e.prototype.start = function() {
      ...
      if (
        ...
        k2(!!t3.streamToken), this.lastStreamToken = t3.streamToken, this.lh
      ) {
        this.Gu.reset();
        var e2 = function(t4, e3) {
          return t4 && t4.length > 0 ? (k2(void 0 !== e3), t4.map(function(t5) {
            return function(t6, e4) {
              ...
              n3.isEqual(X2.min()) && // The Firestore Emulator currently returns an update time of 0 for
...
var Wo = (
  ...
  function() {
    function t2(t3, e) {
      this._s = t3, this.fa = e, /** The current OnlineState. */
      this.state = "Unknown", /**
    ...
    return t2.prototype.Ph = function() {
      ...
      0 === this.mh && (this.yh(
        ...
        return t3.Ah = null, t3.gh("Backend didn't respond within 10 seconds."), t3.yh(
          "Offline"
          /* Offline */
        ), Promise.resolve();
      }));
    ...
    t2.prototype.Vh = function(t3) {
      "Online" === this.state ? this.yh(
        "Unknown"
        /* Unknown */
      ) : (this.mh++, this.mh >= 1 && (this.ph(), this.gh("Connection failed 1 times. Most recent error: " + t3.toString()), this.yh(
        "Offline"
        /* Offline */
      )));
    }, /**
    ...
    t2.prototype.set = function(t3) {
      this.ph(), this.mh = 0, "Online" === t3 && // We've connected to watch at least once. Don't warn the developer
      // about being offline going forward.
      (this.Rh = false), this.yh(t3);
...
var Zo = function(t2, e, n2, r2, i) {
  var o = this;
  this.bh = t2, this.Sh = e, this._s = n2, this.Dh = {}, /**
  ...
  this.Ch = [], /**
           ...
           */
  this.xh = /* @__PURE__ */ new Map(), /**
           * A set of reasons for why the RemoteStore may be offline. If empty, the
           * RemoteStore may start its network connections.
           */
  this.Nh = /* @__PURE__ */ new Set(), /**
           ...
           */
  this.$h = [], this.Fh = i, this.Fh.ou(function(t3) {
    n2.Ps(function() {
              ...
              return uu(this) ? (N2("RemoteStore", "Restarting streams for network reachability change."), [4, function(t5) {
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(n3) {
                    switch (n3.label) {
                      case 0:
                        return (e2 = O2(t5)).Nh.add(
                          4
                          /* ConnectivityChange */
                        ), [4, $o(e2)];
                      case 1:
                        return n3.sent(), e2.Oh.set(
                          "Unknown"
                          /* Unknown */
                        ), e2.Nh.delete(
                          4
...
function tu(t2, e) {
  var n2 = O2(t2);
  n2.xh.has(e.targetId) || // Mark this as something the client is currently listening for.
  (n2.xh.set(e.targetId, e), ou(n2) ? (
...
function eu(t2, e) {
  ...
  n2.xh.delete(e), r2.Hu() && ru(n2, e), 0 === n2.xh.size && (r2.Hu() ? r2.Xu() : uu(n2) && // Revert to OnlineState.Unknown if the watch stream is not open and we
...
function cu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(n2) {
      return su(t2), // If we still need the watch stream, retry the connection.
      ou(t2) ? (t2.Oh.Vh(e), iu(t2)) : (
          ...
          return i = u.sent(), n2._(i) >= 0 ? [
            ...
            function(t3, e2) {
              ...
              n3.Fe.forEach(function(e3) {
                var n4 = t3.xh.get(e3);
                if (n4) {
                  t3.xh.set(e3, n4.Mt(U2.T, n4.Ot)), // Cause a hard reset by unwatching and rewatching immediately, but
          ...
          return e && Iu(t2)._h ? [4, function(t3, e2) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(i) {
                switch (i.label) {
                  case 0:
                    return en(r2 = e2.code) && r2 !== M2.ABORTED ? (n3 = t3.Ch.shift(), // In this case it's also unlikely that the server itself is melting
                    // down -- this was just a bad request so inhibit backoff on the next
                    // restart.
                    Iu(t3).Yu(), [4, lu(t3, function() {
...
function bu(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        case 0:
          return n2 = O2(t2), e ? (n2.Nh.delete(
            2
            /* IsSecondary */
          ), [4, Jo(n2)]) : [3, 2];
        case 1:
...
function _u(t2) {
  var e = this;
  return t2.Uh || // Create stream (but note that it is not started yet).
  (t2.Uh = function(t3, e2, n2) {
    var r2 = O2(t3);
    ...
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return n2 ? (t2.Uh.Yu(), ou(t2) ? iu(t2) : t2.Oh.set(
              "Unknown"
              /* Unknown */
            ), [3, 3]) : [3, 1];
          case 1:
...
function Iu(t2) {
  var e = this;
  return t2.Qh || // Create stream (but note that it is not started yet).
  (t2.Qh = function(t3, e2, n2) {
    var r2 = O2(t3);
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        ...
        case 4:
          ...
          e.Gh(n2.onlineState), o.Kh && e.zh(o.Kh) && xu(n2), [
            2
            /*return*/
          ];
      }
...
function Au(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n2, r2, i, o, u;
    return __generator(this, function(s) {
      return n2 = O2(t2), r2 = e.query, i = false, (o = n2.queries.get(r2)) && (u = o.listeners.indexOf(e)) >= 0 && (o.listeners.splice(u, 1), i = 0 === o.listeners.length), i ? [2, (n2.queries.delete(r2), n2.Hh(r2))] : [
        2
        /*return*/
      ];
    });
...
var ku = (
  ...
  function() {
    function t2(t3, e, n2) {
      this.query = t3, this.Jh = e, /**
           * Initial snapshots (e.g. from cache) may not be propagated to the wrapped
           * observer. This flag is set to true once we've actually raised an event.
           */
      this.Yh = false, this.Xh = null, this.onlineState = "Unknown", this.options = n2 || {};
    }
...
var Vu = (
  ...
  function() {
    function t2(t3, e, n2) {
      this.il = t3, this.bh = e, this.Qt = n2, /** Batched queries to be saved into storage */
      this.queries = [], /** Batched documents to be saved into storage */
      this.documents = [], this.progress = Cu(t3);
    }
...
var Uu = (
  ...
  function() {
    function t2(t3, e) {
      this.query = t3, this.cl = e, this.al = null, /**
           * A flag whether the view is current with the backend. A view is considered
           * current after it has seen the current flag from the backend and did not
           * lose consistency within the watch stream (e.g. because of an existence
           * filter mismatch).
           */
      this.Be = false, /** Documents in the view but not in the remote target */
      this.ul = mn(), /** Document Keys that have local changes */
      this.De = mn(), this.hl = ye(t3), this.ll = new bn(this.hl);
    }
    ...
    t2.prototype.fl = function(t3, e) {
      ...
      if (t3.Xt(function(t4, e2) {
        ...
        var l = !!h3 && n2.De.has(h3.key), p2 = !!f && (f.Vt || // We only consider committed mutations for documents that were
        // mutated during the lifetime of the view.
        n2.De.has(f.key) && f.hasCommittedMutations), d = false;
        h3 && f ? h3.data().isEqual(f.data()) ? l !== p2 && (r2.track({
          ...
          type: 2,
          doc: f
        }), d = true, (a && n2.hl(f, a) > 0 || c && n2.hl(f, c) < 0) && // This doc moved from inside the limit to outside the limit.
        // That means there may be some other doc in the local cache
        // that should be included instead.
        (s = true)) : !h3 && f ? (r2.track({
          type: 0,
          doc: f
        ...
        (s = true)), d && (f ? (u = u.add(f), o = p2 ? o.add(t4) : o.delete(t4)) : (u = u.delete(t4), o = o.delete(t4)));
     ...
     */
    t2.prototype.Gh = function(t3) {
      return this.Be && "Offline" === t3 ? (
        // If we're offline, set `current` to false and then call applyChanges()
        // to refresh our syncState and generate a ViewChange as appropriate. We
        // are guaranteed to get a new TargetChange that sets `current` back to
        // true once the client is back online.
        (this.Be = false, this.wi(
          {
            ll: this.ll,
            dl: new _n(),
            De: this.De,
    ...
    t2.prototype.ml = function(t3) {
      return !this.cl.has(t3) && // The local store doesn't think it's a result, so it shouldn't be in limbo.
      !!this.ll.has(t3) && !this.ll.get(t3).Vt;
    }, /**
  ...
  function() {
    function t2(t3, e, n2, r2, i, o) {
      ...
      this.Cl = new rn(tt.H), /**
           ...
           */
      this.xl = /* @__PURE__ */ new Map(), this.Nl = new go(), /** Stores user completion handlers, indexed by User and BatchId. */
      this.$l = {}, /** Stores user callbacks waiting for all pending writes to be acknowledged. */
      this.Fl = /* @__PURE__ */ new Map(), this.Ol = Di.Li(), this.onlineState = "Unknown", // The primary state is set to `true` or `false` immediately after Firestore
      ...
      switch (a.label) {
        case 0:
          return n2 = ys(t2), (o = n2.vl.get(e)) ? (
            ...
            (r2 = o.targetId, n2.Vl.Fa(r2), i = o.view.Rl(), [3, 4])
          ) : [3, 1];
        case 1:
      ...
      switch (o.label) {
        case 0:
          return n2 = O2(t2), r2 = n2.vl.get(e), (i = n2.Sl.get(r2.targetId)).length > 1 ? [2, (n2.Sl.set(r2.targetId, i.filter(function(t3) {
            return !le(t3, e);
          })), void n2.vl.delete(e))] : n2.Ml ? (
            // We need to remove the local query target first to allow us to verify
            // whether any other client is still interested in this target.
            (n2.Vl.ka(r2.targetId), n2.Vl.Da(r2.targetId) ? [3, 2] : [4, co(
              n2.bh,
              r2.targetId,
            ...
            return r3.persistence.runTransaction("Locally write mutations", "readwrite", function(t4) {
              return r3.Tc.Xo(t4, o2).next(function(o3) {
                ...
                for (var u2 = [], s2 = 0, a = e2; s2 < a.length; s2++) {
                  ...
                  // exists=true
                  u2.push(new Qe(c.key, h2, kt(h2.proto.mapValue), Re.exists(true)));
                }
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 2:
          ...
          e.$e.forEach(function(t3, e2) {
            var r3 = n2.xl.get(e2);
            r3 && // Since this is a limbo resolution lookup, it's for a single document
            // and it could be added, modified, or removed, but not a combination.
            (k2(t3.qe.size + t3.Ue.size + t3.Qe.size <= 1), t3.qe.size > 0 ? r3.Pl = true : t3.Ue.size > 0 ? k2(r3.Pl) : t3.Qe.size > 0 && (k2(r3.Pl), r3.Pl = false));
          }), [4, is(n2, r2, e)];
        case 3:
          return i.sent(), [3, 6];
        case 4:
    ...
    return __generator(this, function(c) {
      switch (c.label) {
        ...
        case 1:
          ...
          r2.Cl = r2.Cl.remove(o), r2.xl.delete(e), rs(r2), [3, 4];
        case 2:
          return [4, co(
            r2.bh,
            e,
      ...
      switch (o.label) {
        ...
        case 2:
          ...
          Ju(
            ...
            /*error=*/
            null
          ), Zu(n2, r2), n2.Vl.Na(r2, "acknowledged"), [4, is(n2, i)];
        case 3:
          return o.sent(), [3, 6];
        case 4:
          return [4, mi(o.sent())];
    ...
    return __generator(this, function(o) {
      switch (o.label) {
        ...
        case 2:
          ...
          // listen events.
          Ju(r2, e, n2), Zu(r2, e), r2.Vl.Na(e, "rejected", n2), [4, is(r2, i)];
        case 3:
          return o.sent(), [3, 6];
        case 4:
          return [4, mi(o.sent())];
...
function $u(t2, e, n2) {
  ...
  t2.Sl.delete(e), t2.Ml && t2.Nl.Fc(e).forEach(function(e2) {
    t2.Nl.Fi(e2) || // We removed the last reference for this key
    ts(t2, e2);
  });
}
function ts(t2, e) {
...
function es(t2, e, n2) {
  for (var r2 = 0, i = n2; r2 < i.length; r2++) {
    var o = i[r2];
    o instanceof Lu ? (t2.Nl.nr(o.key, e), ns(t2, o)) : o instanceof Ru ? (N2("SyncEngine", "Document no longer in limbo: " + o.key), t2.Nl.ir(o.key, e), t2.Nl.Fi(o.key) || // We removed the last reference for this key
    ts(t2, o.key)) : x2();
  }
}
function ns(t2, e) {
                ...
                switch (f.label) {
                  ...
                  case 4:
                    for (i2 = 0, o2 = e2; i2 < o2.length; i2++)
                      u2 = o2[i2], s2 = u2.targetId, u2.fromCache || (a = n3.fc.get(s2), c = a.Ot, h2 = a.Lt(c), // Advance the last limbo free snapshot version
                      n3.fc = n3.fc.zt(s2, h2));
                    return [
                      2
                      /*return*/
                    ];
    ...
    return __generator(this, function(i) {
      switch (i.label) {
        ...
        case 1:
          ...
          n2.Vl.Ua(e, r2.mc, r2.Ac), [4, is(n2, r2.Ic)];
        case 2:
          i.sent(), i.label = 3;
        case 3:
          return [
      ...
      switch (u.label) {
        ...
        case 3:
          "acknowledged" === n2 || "rejected" === n2 ? (
            ...
            // other clients.
            (Ju(i, e, r2 || null), Zu(i, e), function(t3, e2) {
              O2(O2(t3).zo).xi(e2);
            }(i.bh, e))
          ) : x2(), u.label = 4;
        case 4:
    ...
    return __generator(this, function(p2) {
      switch (p2.label) {
        case 0:
          ...
          i = 0, o = e, p2.label = 1;
        case 1:
          return i < o.length ? (u = o[i], r2.Sl.has(u) ? (
            // A target might have been added in a previous attempt
            (N2("SyncEngine", "Adding an already active target " + u), [3, 5])
          ) : [4, fo(r2.bh, u)]) : [3, 6];
        case 2:
      ...
      return __awaiter(this, void 0, void 0, function() {
        return __generator(this, function(e) {
          switch (e.label) {
            ...
            case 1:
              return e.sent(), this.Gl = this.zl(t3), this.bh = this.Hl(t3), [
                2
                /*return*/
              ];
          }
  ...
  function(t2) {
    function e(e2, n2) {
      ...
      return (r2 = t2.call(
        ...
        /* forceOwnership= */
        false
      ) || this).Yl = e2, r2.cacheSizeBytes = n2, r2.synchronizeTabs = true, r2;
    }
    return __extends(e, t2), e.prototype.initialize = function(e2) {
      return __awaiter(this, void 0, void 0, function() {
        var n2, r2 = this;
                ...
                return __awaiter(r2, void 0, void 0, function() {
                  return __generator(this, function(e3) {
                    switch (e3.label) {
                      ...
                      case 1:
                        return e3.sent(), this.Gl && (t3 && !this.Gl.Er ? this.Gl.start(this.bh) : t3 || this.Gl.stop()), [
                          2
                          /*return*/
                        ];
                    }
      ...
      return function(t3) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(n2) {
            switch (n2.label) {
              case 0:
                return e = O2(t3), N2("RemoteStore", "RemoteStore shutting down."), e.Nh.add(
                  5
                  /* Shutdown */
                ), [4, $o(e)];
              case 1:
                return n2.sent(), e.Fh.ko(), // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
...
var Ns = (
  ...
  function() {
    function t2(t3, e) {
      var n2 = this;
      this.r_ = t3, this.Qt = e, /** Cached bundle metadata. */
          ...
          switch (n2.label) {
            ...
            case 3:
              return 0 === this.buffer.length ? [2, null] : (
                ...
                ((t3 = this.l_()) < 0 && this.u_("Reached the end of bundle when a length string is expected."), e = this.buffer.slice(0, t3), [2, (this.buffer = this.buffer.slice(t3), e)])
              );
          }
        });
      });
...
var Fs = (
  ...
  function() {
    function t2(t3, e, n2) {
      this.v_ = e, this.S_ = n2, /** The type of this Firestore reference. */
...
var js = (
  ...
  function() {
    function t2(t3, e, n2) {
      this.v_ = e, this.C_ = n2, /** The type of this Firestore reference. */
...
function Gs(t2, e) {
  ...
  if (t2 instanceof Ss && (t2 = t2.d_), xs("collection", "path", e), t2 instanceof qs)
    return Vs(n2 = Z2.ot.apply(Z2, __spreadArrays([e], r2))), new zs(
      t2,
      /* converter= */
      null,
      n2
...
function Bs(t2, e) {
  for (var n2, r2 = [], i = 2; i < arguments.length; i++)
    r2[i - 2] = arguments[i];
  if (t2 instanceof Ss && (t2 = t2.d_), // We allow omission of 'pathString' but explicitly prohibit passing in both
  // 'undefined' and 'null'.
  1 === arguments.length && (e = V2.u()), xs("doc", "path", e), t2 instanceof qs)
...
var Js = (
  ...
  function() {
    function t2(t3, e, n2, r2, i, o) {
      this.settings = t3, this.t = e, this.Qt = n2, this.ignoreUndefinedProperties = r2, // Minor hack: If fieldTransforms is undefined, we assume this is an
...
function fa2(t2, e) {
  if (
    ...
    // from firestore-exp.
    t2 instanceof Ss && (t2 = t2.d_), pa2(t2)
  )
  ...
  if (
    ...
    e.path && e.Gt.push(e.path), t2 instanceof Array
  ) {
...
function va(t2, e, n2) {
  if (
    ...
    // FieldPath.
    e instanceof Ss && (e = e.d_), e instanceof As
  )
    return e.f_;
  if ("string" == typeof e)
    return ma2(t2, e);
...
var ba2 = (
  ...
  function() {
    function t2(t3) {
      this.Sh = t3, // The version of each document that was read during this transaction.
      this.Y_ = /* @__PURE__ */ new Map(), this.mutations = [], this.X_ = false, /**
        ...
        return __generator(this, function(n2) {
          switch (n2.label) {
            case 0:
              if (this.nf(), this.Z_)
                throw this.Z_;
              return t3 = this.Y_, // For each mutation, note that the doc was written.
...
var _a = (
  ...
  function() {
    function t2(t3, e, n2, r2) {
      this._s = t3, this.Sh = e, this.updateFunction = n2, this.Es = r2, this.cf = 5, this.Gu = new Qo(
        this._s,
        "transaction_retry"
        /* TransactionRetry */
      );
...
var Ia2 = (
  ...
  function() {
    ...
    return t2.prototype.getConfiguration = function() {
      ...
      var e = this;
      this._f = t3, // eslint-disable-next-line @typescript-eslint/no-floating-promises
              ...
              return function(t3, e2) {
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(i2) {
                    switch (i2.label) {
                      case 0:
                        return (n4 = O2(t3))._s.Af(), N2("RemoteStore", "RemoteStore received new credentials"), r3 = uu(n4), // Tear down and re-create our network streams. This will ensure we get a
              ...
              var o2 = new Ts({
                next: function(o3) {
                  ...
                  !s && o3.fromCache ? (
                    ...
                    i2.reject(new q2(M2.UNAVAILABLE, "Failed to get document because the client is offline."))
                  ) : s && o3.fromCache && r4 && "server" === r4.source ? i2.reject(new q2(M2.UNAVAILABLE, 'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')) : i2.resolve(o3);
                },
                error: function(t4) {
                  return i2.reject(t4);
                }
...
var Ca2 = (
  ...
  function() {
    function t2() {
      ...
      // be changed again.
      this.yf = false, // Operations scheduled to be queued in the future. Operations are
      ...
      this.pf = false, // List of TimerIds to fast-forward delays for.
      ...
      return __generator(this, function(o) {
        switch (o.label) {
          ...
          case 3:
            ...
            */
            function(t3) {
              return "FirebaseError" === t3.name ? t3.code === M2.FAILED_PRECONDITION || t3.code === M2.UNIMPLEMENTED : !("undefined" != typeof DOMException && t3 instanceof DOMException) || (22 === t3.code || 20 === t3.code || // Firefox Private Browsing mode disables IndexedDb and returns
...
var Nc2 = (
  ...
  function(t2) {
    ...
    return __extends(e, t2), Object.defineProperty(e.prototype, "I_", {
      ...
      delete (t3 = Object.assign(Object.assign({}, this.d_.V_()), t3)).merge, this.d_.g_(t3);
                ...
                switch (n3.label) {
                  case 0:
                    return e4 = function(t6, e5) {
                      O2(t6).Wh.add(e5), // Immediately fire an initial event, indicating all existing listeners
                      // are in-sync.
                      e5.next();
                    }, [4, Oa(t5)];
                  case 1:
            ...
            return __awaiter(n2, void 0, void 0, function() {
              ...
              return __generator(this, function(i) {
                switch (i.label) {
                  ...
                  case 1:
                    return n3 = i.sent(), new _a(t5._s, n3, e4, r2).run(), [
                      2
                      /*return*/
                    ];
                }
...
var Uc2 = (
  ...
  function(t2) {
    ...
    return __extends(e, t2), e.prototype.where = function(t3, n2, r2) {
      ...
      try {
        return new e(this.firestore, Xa2(this.d_, function(t4) {
          return Rs("limitToLast", t4), new Ja2(
            "limitToLast",
            t4,
            "L"
            /* Last */
  ...
  */
  function(e2, r2) {
    e2.INTERNAL.registerComponent(new Component(
      ...
      "PUBLIC"
      /* PUBLIC */
    ).setServiceProps(Object.assign({}, I3)));
  }(e, function(e2, s) {
...
@firebase/firestore/dist/esm5/prebuilt-67479dbf-318e5a2c.js:
  (**
   * @license
